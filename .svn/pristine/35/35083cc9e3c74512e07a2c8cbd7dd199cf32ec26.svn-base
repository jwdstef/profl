...
public class UploadConfigurationRead  {
     ...
     */
    private static String PFILE = "com/radixdigit/config/prop/upload.properties";
     ...
     * 唯一实例
     */
    private static  UploadConfigurationRead m_instance(){
    	 return new UploadConfigurationRead();
    } 
     ...
     */
    public UploadConfigurationRead() {
        try {
     ...
     * 读取一特定的属性项
     */
    public String getConfigItem(HttpServletRequest request,String name, String defaultVal) {
     ...
     */
    public String getConfigItem(HttpServletRequest request,String name) {
        return getConfigItem(request,name, "");
    }
