...
<body>
				...
				<ul class="nav nav-list">
					<c:choose>
						<c:when test="${not empty lines}">
							<c:forEach items="${lines}" var="net" varStatus="vs">
 ...
 -->
						...
						<c:when test="${not empty lines}">
							<c:forEach items="${lines}" var="net" varStatus="vs">
								<li class="open"><a href="#" class="dropdown-toggle"> <i
										class="icon-desktop"></i> <span class="menu-text">
											线路${net.name } </span> <b class="arrow icon-angle-down"></b>
								</a>
								<ul class="submenuj">
								<c:forEach items="${net.towerList}" var="tower" varStatus="vs">
											<li class="active open">
											<a href="#" class="dropdown-toggle"> 
												<i class="icon-double-angle-right"></i> 杆塔${tower.name }
												 <b class="arrow icon-angle-down"></b>
											</a>
											<ul class="submenu">
										<c:forEach items="${tower.pointList}" var="point" varStatus="vs">
												<li>
													<a href="javascript:void(0)" onclick="onMenuChange('jsp/charts.jsp?nodeNum=${point.baseCode }','法人客户');">
														<i class="icon-leaf"></i>
														站点${point.name }
													</a>
												</li>
						...
						<li class="active">
							...
							<ul class="submenu">
								<li class="active open">
									...
									<ul class="submenu">
										<li>
											<a href="javascript:void(0)" onclick="onMenuChange('jsp/charts.jsp?nodeNum=1','法人客户');">
												<i class="icon-leaf"></i>
												站点001
											</a>
										</li>
										...
										<li>
											<a href="javascript:void(0)" onclick="onMenuChange('jsp/charts.jsp?nodeNum=2','法人客户');">
												<i class="icon-leaf"></i>
												站点002
											</a>
										</li>
										<li>
											<a href="javascript:void(0)" onclick="onMenuChange('jsp/charts.jsp?nodeNum=3','法人客户');">
												<i class="icon-leaf"></i>
												站点003
											</a>
										</li>
		...
		$(function() {
			...
			function onMenuChange(url,nodeNum){
				$("#main").attr("src",url);
				$("#pageTitle").html(nodeNum);
			}
