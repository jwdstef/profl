...
public class Page {
	private int showCount = 3; //每页显示记录数
	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			if(currentPage==1){
				...
				sb.append("	<li class=\"disabled\"><a href=\"javascript:void(0)\">上页</a></li>\n");
			}else{	
			...
			if(currentPage==totalPage){
				sb.append("	<li class=\"disabled\"><a href=\"javascript:void(0)\">下页</a></li>\n");
			...
			sb.append("	<li class=\"disabled\"><a href=\"javascript:void(0)\">第"+currentPage+"页</a></li>\n");
			sb.append("	<li class=\"disabled\"><a href=\"javascript:void(0)\">共"+totalPage+"页</a></li>\n");
			sb.append("</ul>\n");
